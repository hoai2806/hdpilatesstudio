...
<head>
    ...
    <title>Thống kê thời gian - HD Pilates</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="time_stats.php">Thống kê thời gian</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Số buổi tập theo thời gian</h5>
                    </div>
                    <div class="card-body">
